...
----
include::{docs-kotlin}/web/reactive/webflux/MyRestController.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/web/reactive/webflux/MyRoutingConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/web/reactive/webflux/MyUserHandler.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/web/reactive/webflux/httpcodecs/MyCodecsConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/web/reactive/webflux/errorhandling/MyErrorWebExceptionHandler.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/web/reactive/webflux/errorhandling/MyExceptionHandlingController.kt[]
----
