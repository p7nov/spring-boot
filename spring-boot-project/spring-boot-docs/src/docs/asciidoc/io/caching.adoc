...
----
include::{docs-kotlin}/io/caching/MyMathService.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/io/caching/provider/MyCacheManagerConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/io/caching/provider/couchbase/MyCouchbaseCacheManagerConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/io/caching/provider/redis/MyRedisCacheManagerConfiguration.kt[]
----
