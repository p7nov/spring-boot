...
----
include::{docs-kotlin}/io/restclient/resttemplate/MyService.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/io/restclient/resttemplate/customization/MyRestTemplateCustomizer.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/io/restclient/resttemplate/customization/MyRestTemplateBuilderConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/io/restclient/webclient/MyService.kt[]
----
