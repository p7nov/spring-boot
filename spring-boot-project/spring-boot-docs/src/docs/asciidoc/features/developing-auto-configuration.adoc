...
----
include::{docs-kotlin}/features/developingautoconfiguration/conditionannotations/classconditions/MyAutoConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/features/developingautoconfiguration/conditionannotations/beanconditions/MyAutoConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/features/developingautoconfiguration/testing/MyServiceAutoConfigurationTests.kt[tag=runner]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/features/developingautoconfiguration/testing/MyServiceAutoConfigurationTests.kt[tag=test-user-config]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/features/developingautoconfiguration/testing/MyServiceAutoConfigurationTests.kt[tag=test-env]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/features/developingautoconfiguration/testing/MyConditionEvaluationReportingTests.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/features/developingautoconfiguration/testing/MyServiceAutoConfigurationTests.kt[tag=test-classloader]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/features/developingautoconfiguration/customstarter/configurationkeys/AcmeProperties.kt[]
----
