...
----
include::{docs-kotlin}/messaging/amqp/sending/MyBean.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/messaging/amqp/receiving/MyBean.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/messaging/amqp/receiving/custom/MyRabbitConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/messaging/amqp/receiving/custom/MyBean.kt[]
----
