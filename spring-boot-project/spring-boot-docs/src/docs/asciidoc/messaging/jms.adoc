...
----
include::{docs-kotlin}/messaging/jms/sending/MyBean.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/messaging/jms/receiving/MyBean.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/messaging/jms/receiving/custom/MyJmsConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/messaging/jms/receiving/custom/MyBean.kt[]
----
