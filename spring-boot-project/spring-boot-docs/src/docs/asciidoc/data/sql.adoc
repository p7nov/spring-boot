...
----
include::{docs-kotlin}/data/sql/jdbctemplate/MyBean.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/data/sql/jpaandspringdata/entityclasses/City.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/data/sql/jpaandspringdata/repositories/CityRepository.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/data/sql/jpaandspringdata/repositories/CountryRepository.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/data/sql/r2dbc/MyR2dbcConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/data/sql/r2dbc/MyPostgresR2dbcConfiguration.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/data/sql/r2dbc/usingdatabaseclient/MyBean.kt[]
----
...
[source,kotlin,indent=0,subs="verbatim",role="secondary"]
----
include::{docs-kotlin}/data/sql/r2dbc/repositories/CityRepository.kt[]
----
